...
rm(list=ls())
setwd("/Users/peterwang/Desktop/HHLM/model2")
source("/Users/peterwang/Desktop/HHLM/funcs/model.R")
source("/Users/peterwang/Desktop/HHLM/funcs/lasso.R")
set.seed(2020)

#---------------Step 1: Set parameters--------------------------------#
Nvec=c(100, 150, 200, 250, 300, 350, 400, 450, 500, 550, 600)                      # sample size
...
for (k in 1:length(lambdaseqconstant)){
    for (i in 1:length(Nvec)){
        ...
        trainingdata=HHR2(Nvec[i], n, Sigmax, truebeta, L2)
...
finalresults=list(avgl2=avgl2, avgl1=avgl1, avgMSE=avgMSE,
                  ...
                  avgrecall=avgrecall, avgprecision=avgprecision, avgFDR=avgFDR)
